        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <Card className="font-[OpenSans] px-5 py-5">
            <CardHeader>
              ...
              <CardDescription>
                Configura el software con diferentes modulos que te facilitamos
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  ...
                  <div className="flex-1 space-y-1">
                    <p className="text-sm font-bold leading-none">Datos</p>
                    <p className="text-sm text-muted-foreground">
                      Configura los datos del laboratorio, la ubicación, telefonos, etc.
                    </p>
                  </div>
